...
def main_train():
    ...
    torch.save(autoencoder, 'autoencoder80.pkl')
    np.savetxt('cpAE_train_loss80.dat', AE_train_loss, delimiter='\t')
    np.savetxt('cpAE_test_loss80.dat', AE_test_loss, delimiter='\t')
