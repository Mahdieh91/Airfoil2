...
def main_train():
    ...
    torch.save(autoencoder, 'autoencoder40.pkl')
    np.savetxt('cpAE_train_loss40.dat', AE_train_loss, delimiter='\t')
    np.savetxt('cpAE_test_loss40.dat', AE_test_loss, delimiter='\t')
