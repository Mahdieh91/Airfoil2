...
def main_train():
    ...
    torch.save(autoencoder, 'autoencoder10.pkl')
    np.savetxt('cpAE_train_loss10.dat', AE_train_loss, delimiter='\t')
    np.savetxt('cpAE_test_loss10.dat', AE_test_loss, delimiter='\t')
